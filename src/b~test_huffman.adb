pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_huffman.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_huffman.adb");
...
package body ada_main is
   ...
   E143 : Short_Integer; pragma Import (Ada, E143, "huffman_E");
